  ...
  <div class="flex flex-col justify-between items-center bg-base-200 h-screen">
    ...
    <div class="bg-base-100 shadow-xl rounded-2xl my-4">
      ...
      <div class="dropdown w-full rounded-2xl rounded-b-none bg-base-300">
        <div class="bg-opacity-100">
          <div class="tabs w-full flex-grow-0">
            ...
            <a href="history.php" class="tab tab-lifted tab-active tab-border-none tab-lg flex-1 text-accent font-medium hover:bg-base-200">Historique</a>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 m-8 mt-4 gap-4 justify-items-center">
        <!-- Title -->
        <h2 class="text-center text-2xl font-bold col-span-2 sm:col-span-3">Historique des cuissons</h2>
          ...
          <table class="table w-full">
            ...
            <tbody>
              ...
              if (!isset($planned_cooking) || count($planned_cooking) == 0) {
                echo '<tr><td colspan="4" class="text-center">Aucune cuisson au compteur.</td></tr>';
              } else {
                  ...
                  echo     '</div>
                    ...
                    <th>
                      <div class="flex items-center justify-center gap-2">
                        <a href="phpback/replanned.php?id=' . $cooking['id'] . '">
                          <i class="fa-solid fa-clock-rotate-left text-accent hover:text-accent-focus fa-xl"></i>
                        </a>
                      </div>
                    </th>
                  </tr>';
